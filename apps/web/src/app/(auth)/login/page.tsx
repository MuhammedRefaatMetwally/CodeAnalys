  ...
  const { mutate, isPending } = useMutation({
    ...
    onSuccess: (data) => {
      ...
      toast.success("Welcome back!", {
        description: `Good to see you, ${data.user.name}!`,
      });
  ...
  return (
    <div className="min-h-screen bg-[#080808] flex">
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 30% 50%, rgba(34,197,94,0.08) 0%, transparent 70%)",
        }}
      >
        ...
        <div>
          ...
          <p className="text-zinc-400 text-lg leading-relaxed max-w-sm">
            Paste a GitHub PR URL. Get instant AI-powered feedback on code
